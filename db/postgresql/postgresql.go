...
var (
	Url = "root@tcp(127.0.0.1:5432)/auth"
...
func (m *postgresql) Init() error {
	...
	if d, err = sql.Open("postgresql", url+"/"); err != nil {
		return err
	}
...
func (m *postgresql) run() {
	// postgresql does not expire rows so we must do so.
...
func (m *postgresql) Delete(id string) error {
	_, err := st["delete"].Exec(id)
	return err
}

func (m *postgresql) Create(acc *account.Record, salt string, secret string) error {
...
func (m *postgresql) Update(acc *account.Record, salt string, secret string) error {
	b, err := json.Marshal(acc.Metadata)
	if err != nil {
		return err
	}
...
func (m *postgresql) Read(id string) (*account.Record, error) {
	acc := &account.Record{}
...
func (m *postgresql) Search(clientId, typ string, limit, offset int64) ([]*account.Record, error) {
	var r *sql.Rows
	var err error
...
func (m *postgresql) SaltAndSecret(id string) (string, string, error) {
	acc := &account.Record{}
	r := st["read"].QueryRow(id)
	var salt, secret, meta string
	if err := r.Scan(&acc.Id, &acc.Type, &acc.ClientId, &secret, &salt, &acc.Created, &acc.Updated, &meta); err != nil {
...
func (m *postgresql) CreateRequest(id string, req *oauth2.AuthorizeRequest) error {
...
func (m *postgresql) DeleteRequest(id string) error {
	_, err := st["deleteReq"].Exec(id)
	return err
}

func (m *postgresql) ReadRequest(id string) (*oauth2.AuthorizeRequest, error) {
...
func (m *postgresql) DeleteExpired(t int64) error {
	var gerr error
...
func (m *postgresql) ReadToken(id string) (*oauth2.Token, string, error) {
	tok := &oauth2.Token{}
...
func (m *postgresql) ReadRefresh(id string) (*oauth2.Token, string, error) {
	tok := &oauth2.Token{}
...
func (m *postgresql) CreateToken(t *oauth2.Token, clientId, code string) error {
	// expire in the future
...
func (m *postgresql) UpdateToken(id string, t *oauth2.Token) error {
	// expire in the future
	refreshExpiry := time.Now().Add(db.RefreshExpiry).Unix()
...
func (m *postgresql) DeleteToken(id string) error {
